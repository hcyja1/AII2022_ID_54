...
#Load XGB Classifier
def loadClassifier():
    classification_model = pickle.load(open("../Code/Models/"+database+"/xCeption_XGB_" + database+"_Model.pkl", "rb"))
...
def classify():
    ...
    if(database=="IDB1_cropped"):
        ...
        for label in np.unique(labels):
            ...
            prediction = X1.predict(f1_features)
...
#Start GUI
def GUI():
    global frame,C1,detect_btn,choose_image_IDB1,choose_image_IDB1_cropped,choose_image_IDB2,progress
    ...
    progress_title = tk.Label(root, text="Progress : ", pady=10, padx=8, font=("", 12)).pack(side=tk.RIGHT)
